...
Maximum of four pipelines to be created
...
def set_dataset_inputs(**kwargs):
    ...
    # Look at Women's Tennis Data and make predictions on post match data
    predictions.append('wta_post')

    # Look at Women's Tennis Data and make predictions on matchup only and no match metrics
